...
namespace ObligationCalculationDemoUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        private static List<RecyclingTarget> _entries = new List<RecyclingTarget>
            {
                ...
                new RecyclingTarget { Year = 2025, Material = ObligationCalculationMaterial.Glass, Number = 0.74 },
                ...
                new RecyclingTarget { Year = 2026, Material = ObligationCalculationMaterial.Glass, Number = 0.76 },
                ...
                new RecyclingTarget { Year = 2027, Material = ObligationCalculationMaterial.Glass, Number = 0.78 },
                ...
                new RecyclingTarget { Year = 2028, Material = ObligationCalculationMaterial.Glass, Number = 0.8 },
                ...
                new RecyclingTarget { Year = 2029, Material = ObligationCalculationMaterial.Glass, Number = 0.82 },
                ...
                new RecyclingTarget { Year = 2030, Material = ObligationCalculationMaterial.Glass, Number = 0.85 },
        ...
        {
            TempData["Answer"] = null;

            var target = _entries.FirstOrDefault(x => x.Material == model.Material && x.Year == 2025);

            TempData["Answer"] = new ObligationCalculatorService().Calculate((double)target?.Number, model.Tonnage);            
