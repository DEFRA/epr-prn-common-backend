...
namespace EPR.Accreditation.API.Common.Data.Migrations
{
    ...
    [Migration("20240418083216_Add-Prn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPR.Accreditation.API.Common.Data.DataModels.PackageRecyclingNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AccreditationReference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EPR.Accreditation.API.Common.Data.DataModels.PrnStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPR.Accreditation.API.Common.Data.DataModels.PrnStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPR.Accreditation.API.Common.Data.DataModels.PackageRecyclingNote", b =>
                {
                    b.HasOne("EPR.Accreditation.API.Common.Data.DataModels.PrnStatus", "PrnStatus")
                        .WithMany()
                        .HasForeignKey("PrnStatusId");

                    b.HasOne("EPR.Accreditation.API.Common.Data.DataModels.Lookups.OperatorType", "PrnType")
                        .WithMany()
                        .HasForeignKey("PrnTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PrnStatus");

                    b.Navigation("PrnType");
            ...
            modelBuilder.Entity("EPR.Accreditation.API.Common.Data.DataModels.PrnStatusHistory", b =>
                {
                    b.HasOne("EPR.Accreditation.API.Common.Data.DataModels.PackageRecyclingNote", "Prn")
                        .WithMany()
                        .HasForeignKey("PrnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
