...
public class UpdateRegulatorAccreditationTaskCommandValidator : AbstractValidator<UpdateRegulatorAccreditationTaskCommand>
{
    public UpdateRegulatorAccreditationTaskCommandValidator()
    {
