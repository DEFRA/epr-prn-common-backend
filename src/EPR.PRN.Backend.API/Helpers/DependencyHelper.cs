    ...
    public static class DependencyHelper
    {
        public static IServiceCollection AddDependencies(this IServiceCollection services)
        {
            services
                ...
                .AddScoped<
                    IMaterialCalculationStrategyResolver,
                    MaterialCalculationStrategyResolver
                >()
                ...
                .AddScoped<
                    IObligationCalculationOrganisationSubmitterTypeRepository,
                    ObligationCalculationOrganisationSubmitterTypeRepository
                >()
                .AddScoped<IPrnRepository, PrnRepository>()
                .AddScoped<IValidator<SavePrnDetailsRequest>, SavePrnDetailsRequestValidator>()
                .AddScoped<IValidator<SavePrnDetailsRequest>, SavePrnDetailsRequestValidator>()
                .AddScoped<
                    IValidator<UpdateRegistrationCommand>,
                    UpdateRegistrationCommandValidator
                >()
                .AddScoped<
                    IValidator<UpdateRegulatorRegistrationTaskCommand>,
                    UpdateRegulatorRegistrationTaskCommandValidator
                >()
                .AddScoped<
                    IValidator<UpdateRegulatorApplicationTaskCommand>,
                    UpdateRegulatorApplicationTaskCommandValidator
                >()
                .AddScoped<
                    IRegulatorApplicationTaskStatusRepository,
                    RegulatorApplicationTaskStatusRepository
                >()
                .AddScoped<
                    IRegulatorRegistrationTaskStatusRepository,
                    RegulatorRegistrationTaskStatusRepository
                >()
                .AddScoped<IValidator<SavePrnDetailsRequest>, SavePrnDetailsRequestValidator>()
                ...
                .AddScoped<
                    IRegulatorAccreditationTaskStatusRepository,
                    RegulatorAccreditationTaskStatusRepository
                >()
                ...
                .AddScoped<IOverseasAccreditationSiteService, OverseasAccreditationSiteService>()
                .AddScoped<IAccreditationRepository, AccreditationRepository>()
                .AddScoped<
                    IAccreditationPrnIssueAuthRepository,
                    AccreditationPrnIssueAuthRepository
                >()
                .AddScoped<IAccreditationFileUploadRepository, AccreditationFileUploadRepository>()
                .AddScoped<
                    IOverseasAccreditationSiteRepository,
                    OverseasAccreditationSiteRepository
                >()
                .AddScoped<IRegistrationRepository, RegistrationRepository>()
                .AddScoped<ILookupCountryRepository, CountryRepository>()
                .AddScoped<
                    ICarrierBrokerDealerPermitRepository,
                    CarrierBrokerDealerPermitRepository
                >()
