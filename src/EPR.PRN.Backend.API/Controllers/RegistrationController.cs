    ...
    , ILogger<RegistrationController> logger) : ControllerBase
{
    ...
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<Data.DTO.Registration.RegistrationOverviewDto>))]
    [ProducesResponseType(typeof(ValidationProblemDetails), (int)HttpStatusCode.BadRequest)]
    [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
    [SwaggerOperation(
    ...
    [SwaggerResponse(StatusCodes.Status200OK, "Returns the registrations overview for the given organisation ID", typeof(List<Data.DTO.Registration.RegistrationOverviewDto>))]
    [SwaggerResponse(StatusCodes.Status400BadRequest, "If the request is invalid or a validation error occurs.", typeof(ProblemDetails))]
    [SwaggerResponse(StatusCodes.Status500InternalServerError, "If an unexpected error occurs.", typeof(ContentResult))]
