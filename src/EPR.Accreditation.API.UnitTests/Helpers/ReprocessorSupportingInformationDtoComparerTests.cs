namespace EPR.Accreditation.API.UnitTests.Helpers
{
    ...
    [TestClass]
    public class ReprocessorSupportingInformationDtoComparerTests
    {
        private ReprocessorSupportingInformationDtoComparer _reprocessorSupportingInformationDataComparer;

        [TestInitialize]
        public void Init()
        {
            _reprocessorSupportingInformationDataComparer = new ReprocessorSupportingInformationDtoComparer();
        }
