        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReprocessingSiteAddressId = table.Column<int>(type: "int", nullable: false),
                    LegalDocumentAddressId = table.Column<int>(type: "int", nullable: false),
                    MaterialName = table.Column<string>(type: "nvarchar(20)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Registration_Material_MaterialName",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialName = table.Column<string>(type: "nvarchar(20)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrationContact_Material_MaterialName",
                        column: x => x.MaterialName,
                        principalTable: "Material",
                        principalColumn: "MaterialName",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPeriodId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registration_MaterialName",
                table: "Registration",
                column: "MaterialName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrationContact_MaterialName",
