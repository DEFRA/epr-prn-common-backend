...
BEGIN
    CREATE TABLE [FileUpload] (
        ...
        CONSTRAINT [FK_FileUpload_Material_MaterialId] FOREIGN KEY ([MaterialId]) REFERENCES [Material] ([MaterialName]) ON DELETE CASCADE,
...
BEGIN
    CREATE TABLE [RegistrationContact] (
        ...
        CONSTRAINT [FK_RegistrationContact_Material_MaterialId] FOREIGN KEY ([MaterialId]) REFERENCES [Material] ([MaterialName]) ON DELETE CASCADE,
...
BEGIN
    CREATE TABLE [RegistrationMaterial] (
        ...
        CONSTRAINT [FK_RegistrationMaterial_Material_MaterialId] FOREIGN KEY ([MaterialId]) REFERENCES [Material] ([MaterialName]) ON DELETE CASCADE,
...
BEGIN
    CREATE TABLE [RegistrationReprocessingIO] (
        ...
        CONSTRAINT [FK_RegistrationReprocessingIO_Material_MaterialId] FOREIGN KEY ([MaterialId]) REFERENCES [Material] ([MaterialName]) ON DELETE CASCADE,
