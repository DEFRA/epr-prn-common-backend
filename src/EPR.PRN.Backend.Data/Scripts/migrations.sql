...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250704110021_RegistrationReprocessingIORawMaterialOrProducts'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250704110021_RegistrationReprocessingIORawMaterialOrProducts', N'8.0.8');
END;
GO
