...
namespace EPR.PRN.Backend.API.UnitTests.Validators
{
    ...
    public class UpdateRegulatorRegistrationTaskCommandValidatorTests
    {
        ...
        {
            var model = new UpdateRegulatorRegistrationTaskCommand { TaskName = "Test Task", RegistrationId = 1, Status = RegulatorTaskStatus.Queried, Comments = new string('a', 501), UserName = "UserName" };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new UpdateRegulatorRegistrationTaskCommand { TaskName = "Test Task", RegistrationId = 1, Status = RegulatorTaskStatus.Queried, Comments = new string('a', 500), UserName = "UserName" };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new UpdateRegulatorRegistrationTaskCommand { TaskName = "Test Task", RegistrationId = 1, Status = RegulatorTaskStatus.Queried, Comments = string.Empty, UserName = "UserName" };
            var result = _validator.TestValidate(model);
            result.ShouldHaveValidationErrorFor(x => x.Comments)
        ...
        {
            var model = new UpdateRegulatorRegistrationTaskCommand { TaskName = "Test Task", RegistrationId = 1, Status = RegulatorTaskStatus.Queried, Comments = "Valid comment", UserName = "UserName" };
            var result = _validator.TestValidate(model);
            result.ShouldNotHaveValidationErrorFor(x => x.Comments);
        }
        ...
        {
            var model = new UpdateRegulatorRegistrationTaskCommand { TaskName = "Test Task", RegistrationId = 1, Status = RegulatorTaskStatus.Completed, Comments = string.Empty, UserName = "UserName" };
            var result = _validator.TestValidate(model);
            result.ShouldNotHaveValidationErrorFor(x => x.Comments);
        }
    }
