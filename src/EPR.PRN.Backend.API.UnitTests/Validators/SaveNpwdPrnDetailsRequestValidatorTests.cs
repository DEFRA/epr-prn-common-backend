...
{
    [TestClass]
    public class SaveNpwdPrnDetailsRequestValidatorTests
    {
        private readonly SaveNpwdPrnDetailsRequest _validPrn = new SaveNpwdPrnDetailsRequest()
        {
            AccreditationNo = "ABC",
        ...
        {
            var validator = new SaveNpwdPrnDetailsRequestValidator();
        ...
        public void Test_SaveNpwdPrnDetailsRequestValidator_Returns_Correct_ValidationResultOnInvalidInput(
            string propertyName,
            object propertyValue
        )
        {
