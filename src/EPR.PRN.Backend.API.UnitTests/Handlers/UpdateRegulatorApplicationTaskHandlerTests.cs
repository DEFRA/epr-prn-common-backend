...
namespace EPR.PRN.Backend.API.Tests.Handlers
{
    ...
    public class UpdateRegulatorApplicationTaskHandlerTests
    {
        ...
        private Mock<ILogger<UpdateRegulatorApplicationTaskHandler>> _loggerMock;
        ...
        public void Setup()
        {
            ...
            _loggerMock = new Mock<ILogger<UpdateRegulatorApplicationTaskHandler>>();
            _handler = new UpdateRegulatorApplicationTaskHandler(_repositoryMock.Object, _loggerMock.Object);
        }
        ...
        public async Task Handle_TaskStatusNotFound_ShouldThrowKeyNotFoundException()
        {
            ...
            _repositoryMock.Setup(r => r.GetTaskStatusByIdAsync(command.Id)).ReturnsAsync((RegulatorApplicationTaskStatus)null);
